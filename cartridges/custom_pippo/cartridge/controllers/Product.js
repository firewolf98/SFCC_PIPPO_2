...
server.replace('Show',cache.applyPromotionSensitiveCache, consentTracking.consent, function(req, res, next) {
    ...
    var co2display = productHelper.convertco2value(showProductPageHelperResult.product);
    var sustainabilityColor = productHelper.sustainabilityColor(showProductPageHelperResult.product);
